        ...
        <div className='w-2/12 py-4 relative h-full bg-gray-50 text-gray-900 '>
            ...
            <div className='flex items-center justify-center flex-col  my-2'>
                <ul className='w-full h-full '>
                    ...
                    <li onClick={() => Router.push('/admin/addProduct')}  className='text-lg hover:bg-orange-600 hover:text-white p-2 my-2 border-b border-b-gray-400 transition duration-500 font-semibold flex items-center justify-start mx-4  cursor-pointer '><IoMdAddCircle className='mr-2' /> Add Product</li>
                    <li className='text-lg hover:bg-orange-600 hover:text-white p-2 my-2 border-b border-b-gray-400 transition duration-500 font-semibold flex items-center justify-start mx-4  cursor-pointer '><BiCategory className='mr-2' /> View Products</li>
                    ...
                    <li className='text-lg hover:bg-orange-600 hover:text-white p-2 my-2 border-b border-b-gray-400 transition duration-500 font-semibold flex items-center justify-start mx-4  cursor-pointer '><BiCategory className='mr-2' /> View Categories</li>
